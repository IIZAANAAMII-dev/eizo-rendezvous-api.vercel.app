...
-- Horaires : mardi et vendredi, 09:30-11:30 et 14:00-16:00
...
SELECT av.id, '09:30:00'::time, '11:30:00'::time FROM ins_av av WHERE av.day_of_week = 2
UNION ALL
SELECT av.id, '14:00:00'::time, '16:00:00'::time FROM ins_av av WHERE av.day_of_week = 2
UNION ALL
SELECT av.id, '09:30:00'::time, '11:30:00'::time FROM ins_av av WHERE av.day_of_week = 5
UNION ALL
SELECT av.id, '14:00:00'::time, '16:00:00'::time FROM ins_av av WHERE av.day_of_week = 5;
